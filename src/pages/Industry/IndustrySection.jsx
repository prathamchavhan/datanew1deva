...
import Industry_main from '../../assets/videos/Industry_main.mp4';
...
const containerStyle = {
 ...
 backgroundColor : 'rgba(57, 59, 62, 0.3)',
  ...
  return (
    <div id="industry-section" style={mainStyle}>
      <style>{`
        @keyframes pulse {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.7; }
      ...
      <div style={containerStyle}>
        ...
        <div id="testimonials-section" ref={testimonialsRef} style={testimonialCardStyle}>
          <div style={testimonialContentStyle}>
            {/* Center dividing line */}
            <div style={centerLineStyle}> </div>
            
            <div style={textSectionStyle}>
              <h2 style={titleStyle}>Industry Expertise</h2>
